...
const DICT = {
  en: {
    ...
    on_break: 'You are on a break', on_break_hint: "Dispatch won't auto-assign you while on break",
    take_break: '☕ Take a break', end_break: 'End break',
    ...
    new_password: 'New password', save: 'Save',
    must_change_title: 'Set a new password', must_change_hint: 'Your account requires a new password before you continue.',
  ...
  ar: {
    ...
    on_break: 'أنت في استراحة', on_break_hint: 'لن يتم إسناد مهام تلقائياً أثناء الاستراحة',
    take_break: '☕ أخذ استراحة', end_break: 'إنهاء الاستراحة',
    ...
    new_password: 'كلمة المرور الجديدة', save: 'حفظ',
    must_change_title: 'تعيين كلمة مرور جديدة', must_change_hint: 'يتطلب حسابك كلمة مرور جديدة قبل المتابعة.',
